...
const Navbar = () => {
  ...
  return (
    <nav className="bg-blue-950 text-white flex justify-between items-center px-7 md:h-16">
      <Link
        className="logo font-bold text-xl tracking-wider flex justify-center items-center"
        href={"/"}
      >
        <img className="invertImg" src="/tea.gif" alt="tea gif" width={45} />
        ...
        {session && (
          <>
            ...
            <div
              ...
              className={`z-10 ${
                showdropdown ? "" : "hidden"
              } absolute left-[180px] bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700`}
            >
              <ul
